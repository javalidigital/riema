...
(function ($) {
  ...
  window.InlineShortcodeView_vc_icon_tabs = window.InlineShortcodeView_vc_row.extend({
	events: {
	...
	render: function() {
	  ...
	  window.InlineShortcodeView_vc_icon_tabs.__super__.render.call(this);
	  return this;
	},
	changed: function() {
	...
	updated: function() {
	  window.InlineShortcodeView_vc_icon_tabs.__super__.updated.call(this);
	...
	addElement: function(e) {
	  ...
	  new vc.ShortcodesBuilder()
			.create({shortcode: 'vc_icon_tab', params: {tab_id: vc_guid() + '-' + this.tabsControls().find('li').length, title: this.getDefaultTabTitle()}, parent_id: this.model.get('id')})
			.render();
	},
	getDefaultTabTitle: function() {
	  return this.model.get('shortcode') === 'vc_icon_tabs' ? window.i18nLocale.tab : window.i18nLocale.slide;
	},
	setSorting: function() { {
	  return
	}
	...
	clone: function(e) {
	  ...
	  window.InlineShortcodeView_vc_icon_tabs.__super__.clone.call(this, e);
	}
  });
  window.InlineShortcodeView_vc_tour = window.InlineShortcodeView_vc_icon_tabs.extend({
	render: function() {
	  _.bindAll(this, 'stopSorting');
  ...
  window.InlineShortcodeView_vc_icon_tab = window.InlineShortcodeViewContainerWithParent.extend({
	controls_selector: '#vc-controls-template-vc_icon_tab',
	render: function() {
	  var tab_id, result, active, params;
	  params = this.model.get('params');
	  window.InlineShortcodeView_vc_icon_tab.__super__.render.call(this);
	...
	removeView: function(model) {
	  window.InlineShortcodeView_vc_icon_tab.__super__.removeView.call(this, model);
	  if(this.parent_view && this.parent_view.addTab) {
